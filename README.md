...
目前版本為 **V1.0.16**，顯示於設定頁的「目前版本」卡片，版本來源集中在 `src/app/version.ts`。每次完成專案修改後，修訂號需增加 `0.0.1`；例如 `V1.0.1` 修改為 `V1.0.2`，並同步更新 `package.json` 與 `package-lock.json` 的版本欄位。
